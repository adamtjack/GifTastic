var heroArray = ["Superman", "Batman", "Ironman", "Captain America", "The Hulk"];

$(document).ready(function() {
    for (var i = 0; i < heroArray.length; i++) {
        $("#hero-buttons").append("<button type='button' onclick='searchGif(\"" + heroArray[i] + "\")' class='btn btn-primary' value=' " + heroArray[i] + "'> " + heroArray[i] + " </button>");
    }
});
